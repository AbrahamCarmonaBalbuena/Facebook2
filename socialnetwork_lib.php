        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Tu tienes <?php ?> notifiaciones</li>
              <li>
                ...
                ?>
                  ...
                  <li>
                    <a href="publicacion.php?id=<?php ?>">
                      <i class="fa fa-users text-aqua"></i> El usuario <?php  ?> <?php ?> tu publicación
                    </a>
                  </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="editarperfil.php?id=<?php ?>" class="btn btn-default btn-flat">Editar perfil</a>
                </div>
