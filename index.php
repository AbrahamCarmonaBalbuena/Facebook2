              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="avatars/" alt="Product Image">
                  </div>
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <?php $registrados = mysqli_query($conexion,"SELECT avatar,nombre_de_usuario,fecha_registro FROM user ORDER BY idUser DESC LIMIT 8");
                    while($reg=mysqli_fetch_array($registrados))
                    {
                    ?>
                    <li>
                      <img src="avatars/<?php echo $reg['avatar']  ?>" alt="User Image" width="100" height="200">
                      <a class="users-list-name" href="#"><?php echo $reg['nombre_de_usuario'];?></a>
